...
class Solution:
    def guessNumber(self, n: int) -> int:
        ...
        #for i in range(n+1): print(-guess(i), end='') 測試
        ...
        while left < right: # 左右的範圍還沒有「撞在一起」
            ...
            if guess(mid) < 0: right = mid # (暗示你) 再低一點 (中點設成上界)
        return left
        # week08-3 是要在紙上，把這題 Easy 的 left, right, mid 跟猜的數字搞懂
